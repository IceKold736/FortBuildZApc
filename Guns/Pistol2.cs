...
namespace FortBuildZApc
{
    public class Pistol2
    {
        ...
        public Character2 playerGuy;

        public Pistol2(Character2 c, Texture2D gt)
        {
            playerGuy = c;
            gunTexture = gt;
        }
        ...
        public void Update()
        {
            ...
            gunTemp = new Vector2((float)Math.Cos(playerGuy.orientation), (float)Math.Sin(playerGuy.orientation)) * 6f;
